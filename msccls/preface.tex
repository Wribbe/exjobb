...
\newcommand\titleFirst{Usability testing on the web; Measuring}
\newcommand\titleSecond{how design impacts task performance}
%\newcommand\titleFirst{Usability testing on the web; Building a}
%\newcommand\titleSecond{usability testing platform with Python}
