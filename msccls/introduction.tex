...
%  The corresponding organization to `Dataspelbranchen`
  ...
  It is also worth mentioning as a specific quirk that sets the gaming-industry
...
%  Due to its nature of handling digital product, the game-development has
%  become even more global,
%  Since this is a global industry, even among the employees,
%  Since the industry handles digital goods it makes it hard to rely on
%  proximity to domestic customers in order to ensure a revenue-stream, and each
%  company .


%    It is worth noting that the Swedish increase is
