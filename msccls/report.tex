...
%	\chapter{Approach}
    ...
    \end{figure}
      ...
      for evaluation.
        ...
        \begin{figure}[h!]
          \center
          \includegraphics[valign=t,trim={.10cm .10cm .35cm .25cm},crop,width=.49\linewidth]{ui11.pdf}
          \includegraphics[valign=t,trim={.15cm .30cm .20cm .25cm},crop,width=.49\linewidth]{ui12.pdf}
          \includegraphics[valign=t,trim={.45cm .55cm .65cm .35cm},crop,width=.49\linewidth]{ui13.pdf}
          \includegraphics[valign=t,trim={.25cm .35cm .30cm .25cm},crop,width=.49\linewidth]{ui14.pdf}
...
%      \end{figure}
    ...
    \section{Procedure}
      ...
      \subsection{General information, consent and initial survey}
        ...
        \begin{figure}[h!]
          \centering
          \includegraphics[width=.6\textwidth]{figures/captures/webapp_pre_survey.pdf}
      ...
      \subsection{Information pages and fictional context}
        ...
        Overall, the intent is to give the participant enough concrete
        information about the test at hand while trying to maintain the
        implied fictional context of the task. Which means, any instructions
        and information should be closer to \textit{''select the co-worker with
          the most X''} rather than \textit{''click the largest box''}.
