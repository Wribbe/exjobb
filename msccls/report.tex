...
%			analysis.
	...
	\chapter{Evaluation}
      ...
      \subsection{Preferential task order}
        ...
        Since the legend in figure \ref{testsRunOrder} reflects the order in which the
        ...
        Initially the going-by-order tendency from figure \ref{testsRunOrder}
...
%
      \newpage
      \subsection{Success-rates for task types}
...
%
      ...
      \subsection{Task type impact on time to completion}
