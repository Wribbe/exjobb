...
%	\chapter{Approach}
    ...
    \end{figure}
      ...
      for evaluation.
        ...
        \begin{figure}[h!]
          \center
          \includegraphics[width=.40\linewidth]{ui11.pdf}
          \includegraphics[width=.40\linewidth]{ui12.pdf}
          \includegraphics[width=.40\linewidth]{ui13.pdf}
          \includegraphics[width=.40\linewidth]{ui14.pdf}
      ...
      \subsection{Lo-fi interview structure}
        ...
        \begin{figure}[h!]
          \centering
          \includegraphics[trim={0 0 0 0},crop]{figures/lofi_method.pdf}
...
%\addtocontents{toc}{\pagebreak}
    ...
    \subsection{Sources and Milestones}
      ...
      Looking at completion times for the post-survey group, the average
...
%      \end{figure}
    ...
    \subsection{Varying Testing Hardware}
    ...
    \subsection{Input Methods and Screen Sizes}
      ...
      \todo{Spell out the input alternatives}
    ...
    \section{Procedure}
      ...
      \begin{figure}[h!]
        ...
        \caption{Per-participant test-flow.}
      \end{figure}
      ...
      \subsection{General information, consent and initial survey}
        ...
        \begin{figure}[h!]
          \centering
          \includegraphics[width=.7\textwidth]{figures/webapp_pre_survey.pdf}
        ...
        \begin{figure}[h!]
          \centering
          \fbox{
            \includegraphics[trim={4cm 8cm 9cm 8cm},clip,width=.6\textwidth]{figures/webapp_abort.pdf}
          }
      ...
      \subsection{Main hub-page}
        ...
        \begin{figure}[h!]
          \centering
          \includegraphics[width=.7\textwidth]{figures/webapp_main_statistics.pdf}
      ...
      \subsection{Basis and Purpose of the Test-Tasks}
        ...
        of the suggestions will be abstracted to its simplest goal that still
        resembles the function of the original suggestion. Since the
        overarching goal is to measure if the design of the test has any
        impacts on the performance, the main focus will be on tracking the time
        to completion of the task as accurately as possible.

      \subsection{Test task - Employee Hours}

        \textit{''\ideaOne''}

        Based on first item from the brainstorm list at page \pageref{label_ideas}

      \subsection{Test task - Team Workload}

      \subsection{Test task - Task Dependencies}

      \subsection{Test task - Team Performance}

      \subsection{Post survey}

        As the participant completes five or more tests the 'Take Survey' button
        becomes active, which takes the participant to the post-survey, with the
        option to return to the tests if the button was pressed by accident or if
        the participant had a change of mind. The post-survey consist of eight
        questions and an optional input field for additional comments. These
        questions are ment to evaluate the participants thoughts about the
        current iteration of the testing application in order to derive possible
        improvement for the next implementation iteration.
...
%				multiple runs with same person?
  ...
  \chapter{Appendix}
      ...
      \begin{figure}[h!]
        \centering
        \includegraphics[width=\textwidth]{figures/webapp_information_consent.pdf}
