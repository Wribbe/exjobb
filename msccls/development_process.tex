...
\section{Technology Stack}
  ...
  Since this is a development project, there is a need to choose a technology
  stack. \todo{Expand}
  ...
  In addition to the author having prior experience with Python, the language
  ...
  Since the goal is to collect test-data remotely over the internet, there
...
%  \cite{citetiobe}
  ...
  \subsection{To JavaScript or not to JavaScript}
