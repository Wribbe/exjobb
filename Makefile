...
msccls/report.aux : msccls/report.bib msccls/toc.guard
	cd msccls && pdflatex report && bibtex report

msccls/toc.guard : msccls/report.toc
	touch $@
	cd msccls && pdflatex report
